...
def run_experiment(args, model, iterator, optimizer, criterion):
    ...
    for epoch in range(args.num_epochs):
        ...
        train_loss, train_acc = train(model, train_iterator, optimizer, criterion, train_state)
        valid_loss, valid_acc = evaluate(model, valid_iterator, criterion, train_state)
    ...
    test_loss, test_acc = evaluate(model, valid_iterator, criterion, train_state, mode='test')
